...
<style>
.lst_type {overflow:hiden; width:80%; padding:0 10px 10px; margin:0 auto}
.lst_type li {overflow:hiden; clear:both; margin:10px 0 0; color:2d2c2d;
font-family:'돋움',Dotum; font-size:12px; line-height:100px;
list-style:noen; border-bottom:2px solid lightgray; position:relative;}
	...
	<ul class="lst_type">
		...
		%>
			<li>
				...
				<img src='img/duke.png' width='90' height='90' alt=''></a>
