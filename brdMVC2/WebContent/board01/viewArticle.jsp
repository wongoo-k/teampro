...
<script type="text/javascript">
	...
	function fn_enable_imgnull(obj) {
		document.getElementById("i_title").disabled = false;
		document.getElementById("i_content").disabled = false;
		document.getElementById("tr_btn_modify").style.display = "table-row";
		document.getElementById("tr_btn").style.display = "none";
	...
	<form name="frmArticle" method="post" action="${contextPath}" enctype="multipart/form-data">
		<table border="0" align="center">
			...
			<tr>
				...
				<td>
					<textarea name="content" rows="20" cols="60" id="i_content" disabled>${article.content}</textarea>
				</td>					
			</tr>		
			...
			<tr id="tr_btn">
				<td colspan="2" align="center">
					<c:if test="${imageFileName == null }">
						<input type="button" value="수정하기" onclick="fn_enable_imgnull(this.form)" />
					</c:if>
					<c:if test="${imageFileName != null }">
